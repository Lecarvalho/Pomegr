...
it("renders real direct downloads and navigation when release lookup is unavailable", async () => {
  ...
  expect(html).toContain("Pomegr-Setup-0.3.3-x64.exe");
  expect(html).toContain("220.5 MB");
  expect(html).toContain("Pomegr-Portable-0.3.3-x64.exe");
  expect(html).toContain("220.3 MB");
  expect(html).toContain('href="https://github.com/Lecarvalho/Pomegr/releases/download/v0.3.3/');
