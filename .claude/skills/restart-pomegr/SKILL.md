...
procedure. Read `.agents/skills/restart-pomegr/SKILL.md` from the repository root and follow
it exactly.

That file resolves its script relative to its own directory, which is
`.agents/skills/restart-pomegr/scripts/restart-pomegr.ps1` from the repository root. Run
