...
export function SessionCommandBar({ activityStatus, connected, connecting, historical, paused, desktopState, reportGenerating, canGenerateReport, onGenerateReport, onTogglePause, onSetLaunchAtLogin, onSetCloseBehavior, onSetNotifications, onSetNotificationQuiet, onQuit }: {
