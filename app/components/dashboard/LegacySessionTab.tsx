...
type LegacySessionTabProps = { tab: Exclude<SessionTab, "overview" | "agents" | "activities" | "signals" | "resources">; sessionId: string; historical: boolean; paused: boolean; showEstimatedCost: boolean };
