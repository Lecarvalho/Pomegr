  ...
  return (
    <section className="commandView commandSettings" aria-labelledby="settings-title">
      ...
      <div className="commandSettingsLayout">
        ...
        {section === "about" && <section id="settings-panel-about" className="commandSettingsPane" role="tabpanel" aria-labelledby="settings-tab-about"><h2>About Pomegr</h2><p>A local-first, read-only observer for coding-agent sessions.</p><SettingRow label="Monitor boundary" description="Normalized metadata is served from the loopback monitor. Conversation content remains private."><span className="commandReadyState">Read-only</span></SettingRow><SettingRow label="Application version" description="Command Center shell"><span className="commandMonoValue">v0.2.0</span></SettingRow></section>}
      </div>
    </section>
  );
}
