...
8. Builds the project home snapshot: live-project-only session cards, one batched live-resource sample, bounded per-session context history, and seven-day recorded-only project history.
