...
| Internal pipeline operations and timing | `docs/PIPELINE_OPERATIONS.md`, `monitor/pipeline-operations*.mjs`, `monitor/pipeline-trace*.mjs`, and diagnostic scripts | Browser API fields, transcript/source identity, unrequested diagnostic persistence, or diagnostic reads that trigger pipeline work |
