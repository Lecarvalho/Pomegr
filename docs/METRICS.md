...
is unknown, `open` requires a confirmed owning runtime or a valid owner-backed lease;
recent transcript metadata alone is insufficient. `isLive` includes unresolved recorded
