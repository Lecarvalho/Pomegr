...
const API_PATHS = new Set(["/api/state", "/api/sessions", "/api/session-domain", "/api/session-history", "/api/home", "/api/agents", "/api/usage-limits", "/api/provider-status", "/api/storage", "/api/provider-folders", "/api/events"]);
