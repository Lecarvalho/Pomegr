...
function tabElement(props: Partial<Parameters<typeof LegacySessionTab>[0]> & { sessionId: string; tab: "repository" | "resources" | "details" | "activities" | "signals" }) {
...
function renderTab(props: Partial<Parameters<typeof LegacySessionTab>[0]> & { sessionId: string; tab: "repository" | "resources" | "details" | "activities" | "signals" }) {
