...
describe("session progress estimate", () => {
  ...
  it("marks an old report stale only after later primary activity", () => {
    ...
    const { container } = render(<LiveClockProvider running={false}><SessionProgressPanel progress={progress} agents={[primary]} activity={[{ id: "activity-1", timestamp: "2026-08-11T12:10:30.000Z", actor: "primary", tool: "Read", workKind: "read", detail: "bounded", status: null, durationMs: null, requestId: null }]} connected /></LiveClockProvider>);
