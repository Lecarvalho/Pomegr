...
describe("Agents cache client", () => {
  it("fails closed for malformed or unexpected browser fields", () => {
    ...
    expect(normalizeAgentsSnapshot(snapshot({ runs: [{ id: "r", agentId: "a", sessionId: "s", source: "Codex", project: "Pomegr", sessionTitle: "S", label: "A", assignment: null, role: "unknown", customType: "codex-waiter", model: null, modelEvidence: "unavailable", scope: "delegated", parentId: null, depth: 0, status: "idle", startedAt: null, lastSeen: null, latestContextTotal: null, toolCalls: null, executionTaskCount: null, work: [] }] }))).toEqual(expect.objectContaining({ runs: [expect.objectContaining({ customType: "codex-waiter" })] }));
    expect(normalizeAgentsSnapshot(snapshot({ runs: [{ id: "r", agentId: "a", sessionId: "s", source: "Codex", project: "Pomegr", sessionTitle: "S", label: "A", assignment: null, role: "unknown", customType: "PRIVATE\nTYPE", model: null, modelEvidence: "unavailable", scope: "delegated", parentId: null, depth: 0, status: "idle", startedAt: null, lastSeen: null, latestContextTotal: null, toolCalls: null, executionTaskCount: null, work: [] }] }))).toBeNull();
    for (const value of ["codex/waiter", "codex:waiter", "<waiter>", "unknown", "unavailable", "none", "null"]) {
      expect(normalizeAgentsSnapshot(snapshot({ runs: [{ id: "r", agentId: "a", sessionId: "s", source: "Codex", project: "Pomegr", sessionTitle: "S", label: "A", assignment: null, role: "unknown", customType: value, model: null, modelEvidence: "unavailable", scope: "delegated", parentId: null, depth: 0, status: "idle", startedAt: null, lastSeen: null, latestContextTotal: null, toolCalls: null, executionTaskCount: null, work: [] }] }))).toBeNull();
    }
    expect(normalizeAgentsSnapshot(snapshot({ runs: [{ id: "r", agentId: "a", sessionId: "s", source: "Codex", project: "Pomegr", sessionTitle: "S", label: "A", assignment: null, role: "builder", customType: "codex-waiter", model: null, modelEvidence: "unavailable", scope: "delegated", parentId: null, depth: 0, status: "idle", startedAt: null, lastSeen: null, latestContextTotal: null, toolCalls: null, executionTaskCount: null, work: [] }] }))).toBeNull();
  });
