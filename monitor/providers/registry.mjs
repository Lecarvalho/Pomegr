...
const SESSION_ACTIVITY_STATUSES = new Set(["working", "needs_input", "idle", "open", "stopped", "closed", "unknown"]);

function normalizedSessionActivityStatus(entry) {
  if (!entry?.isLive) return ["idle", "stopped", "closed"].includes(entry?.activityStatus) ? entry.activityStatus : "unknown";
