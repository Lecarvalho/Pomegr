...
const evidenceAgent = z.object({
  ...
  status: z.enum(["active", "waiting", "needs_input", "warm", "finished", "stopped", "idle"]),
  liveness: z.object({ source: z.enum(["owning_app_server", "lifecycle_bridge", "rollout_activity_heuristic"]), observedAt: evidenceTimestamp }).strict().nullable().optional(),
